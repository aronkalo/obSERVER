...
using TCPServer_Client.GameNetworking;
using TCPServer_Client.Gamespace;
using TCPServer_Client.Gamespace.GameMaps;
using TCPServer_Client.Gamespace.GameObjects;
using TCPServer_Client.Gamespace.GameObjects.SealedObjects;
using TCPServer_Client.Gamespace.GameObjects.Structs;
using TCPServer_Client.Gamespace.VirtualSpace.VirtualObjects;
...
namespace TCPServer_Client.GameLogic
{
    public class ServerLogic
    {
        public ServerLogic()
        {
            ClientInfos = new List<GameClientInfo>();
            MapInfo = new MapInformation(SimpleMap.Width, SimpleMap.Height);
        }

        public GameClientInfo server { get; set; }
        public List<GameClientInfo> ClientInfos { get; set; }
        private MapInformation MapInfo { get; set; }
