...
namespace obServer.GameModel.Item
{
    ...
    public sealed class Player : BaseItem, IPlayer, IBaseItem
    {
        ...
        private static Geometry playerGeometry = new EllipseGeometry() { RadiusX = Width, RadiusY = Height };
        ...
        /// <summary>
        /// Gets or sets the player geom.
        /// </summary>
        public static Geometry PlayerGeometry
        {
            get
            {
