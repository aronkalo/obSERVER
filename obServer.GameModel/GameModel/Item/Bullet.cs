...
namespace obServer.GameModel.Item
{
    ...
    public sealed class Bullet : BaseItem, IBullet
    {
        ...
        private static EllipseGeometry bulletGeometry = new EllipseGeometry() { RadiusX = BulletWidth, RadiusY = BulletHeight };
        ...
        /// <summary>
        /// Gets or sets the bullet geometry.
        /// </summary>
        public static EllipseGeometry BulletGeometry
        {
            get
            {
